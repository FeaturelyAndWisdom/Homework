<%@ Page Title="" Language="C#" MasterPageFile="~/ZStudent/StuMasterPage.master" AutoEventWireup="true" CodeFile="changePwd.aspx.cs" Inherits="ZStudent_changePwd" %>
...
<table width="700" border="1" align="center" cellpadding="1">
  ...
  <tr>
    <td colspan="2" align="center"><asp:Button runat="server" Text="提交" OnClick="Unnamed1_Click"/>&nbsp;&nbsp;<asp:Button runat="server" Text="重置" /></td>
  </tr>
</table>
<p>&nbsp;</p>
</asp:Content>
