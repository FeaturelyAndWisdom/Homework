<%@ Page Title="" Language="C#" MasterPageFile="~/ZTeacher/TeaMasterPage.master" AutoEventWireup="true" CodeFile="changePwd.aspx.cs" Inherits="ZTeacher_changePwd" %>
...
<table width="700" border="1" align="center" cellpadding="1">
  ...
  <tr>
    ...
    <td width="518">
        ...
        <asp:TextBox runat="server" TextMode="Password" ID="oldpwd"></asp:TextBox></td>
  </tr>
  <tr>
    <td>新密码：</td>
