<%@ Page Title="" Language="C#" MasterPageFile="~/ZAdmin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="adminwelcome.aspx.cs" Inherits="welcome" %>
...
<div id="module4085360601" class="module expanded">
  ...
  <div class="modulebody">
  	<table>
		<tbody><tr>
			<td valign="top" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;尊敬的<font color="red">超级管理员</font>用户，欢迎使用西安石油大学教学管理系统,今天是<asp:Label runat="server" ID="year"></asp:Label>年<asp:Label runat="server" ID="mouth"></asp:Label>月<asp:Label runat="server" ID="day"></asp:Label>号/<asp:Label runat="server" ID="dday"></asp:Label></td>
		</tr>
		<tr>
