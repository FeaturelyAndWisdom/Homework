<%@ Page Title="" Language="C#" MasterPageFile="~/teacher/TeaMaster.master" AutoEventWireup="true" CodeFile="Lesing.aspx.cs" Inherits="student_myLes" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="lid" DataSourceID="SqlDataSource" Height="208px" Width="943px">
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                        <asp:LinkButton runat="server" CommandArgument='<%# Eval("lid") %>' OnClick="Unnamed_Click">结课并登记成绩</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
    </asp:GridView>
