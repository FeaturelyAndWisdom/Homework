  ...
  <table width="700" border="1" align="center">
    ...
    <tr>
      ...
      <td width="512" align="left">
          ...
          <asp:RequiredFieldValidator ID="validator1" runat="server" Font-Size="10pt" ControlToValidate="name" Display="Static" ErrorMessage="姓名不能为空" ShowMessageBox="true" ShowSummary="false"></asp:RequiredFieldValidator>
      </td>
    ...
    <tr>
      ...
      <td align="left">
          ...
          <asp:RadioButton ID="woman" runat="server" Text="女" Checked="true" GroupName="sex" />
    ...
    <tr>
      ...
      <td align="left">
          <asp:ListBox ID="grade" runat="server" AutoPostBack="true" Rows="1" >
                <asp:ListItem>请选择</asp:ListItem>
          </asp:ListBox>
          </td>
    </tr>
    ...
    <tr>
      ...
      <td align="left">
          ...
          <asp:RequiredFieldValidator ID="validator7" runat="server" Font-Size="10pt" ControlToValidate="email" Display="Static" ErrorMessage="邮箱不能为空"></asp:RequiredFieldValidator>
    ...
    <tr>
      <td colspan="2" align="center">
          ...
          <asp:Button ID="Button2" runat="server" OnClick="reset_Click" Text="重置" />
      </td>
    </tr>
  </table>
</form>
